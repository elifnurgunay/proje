...
namespace proje
{
    public partial class Form1 : Form
    {
        ...
        void Mail()
        {
            ...
            string APPPASSWORD = GetEnvValue("GMAIL_APP_PASSWORD");

            istemci.Credentials = new System.Net.NetworkCredential("elifgunay444@gmail.com", APPPASSWORD);
            istemci.Port = 587;
            ...
            msj.Subject = "#Log";
            msj.From = new MailAddress("elifgunay444@gmail.com");
            msj.To.Add("elifgunay444@gmail.com");
